...
type integrationhealthTests struct {
	Name   string
	Args   map[string]interface{}
	Result string
}

func TestGetBackupPlugins(t *testing.T) {
	...
	tableFile := "../../test_tables/integrationhealth/getbackupplugins.json"
	State, err := ioutil.ReadFile(tableFile)
	if err != nil {
		t.Errorf("could not read test table file: %d", err)
	}

	var getTests []integrationhealthTests
	...
	for _, tt := range getTests {
		t.Run(tt.Name, func(t *testing.T) {
			...
			msi, err := acs.IntegrationHealth.GetBackupPlugins(testParams.args)
        			if msi != nil {
...
func TestGetImageIntegrations(t *testing.T) {
	// variables declaration
	...
	tableFile := "../../test_tables/integrationhealth/getimageintegrations.json"
	State, err := ioutil.ReadFile(tableFile)
	if err != nil {
		t.Errorf("could not read test table file: %d", err)
	}
	...
	for _, tt := range getTests {
		t.Run(tt.Name, func(t *testing.T) {
			...
			msi, err := acs.IntegrationHealth.GetImageIntegrations(testParams.args)
        			if msi != nil {
				jsonbyte, err := json.Marshal(msi)
				if err != nil {
					t.Errorf("error parsing JSON string - %s", err)
...
func TestGetNotifiers(t *testing.T) {
	...
	tableFile := "../../test_tables/integrationhealth/getnotifiers.json"
	State, err := ioutil.ReadFile(tableFile)
	if err != nil {
		t.Errorf("could not read test table file: %d", err)
	}
	...
	for _, tt := range getTests {
		t.Run(tt.Name, func(t *testing.T) {
			...
			msi, err := acs.IntegrationHealth.GetNotifiers(testParams.args)
        			if msi != nil {
				jsonbyte, err := json.Marshal(msi)
				if err != nil {
					t.Errorf("error parsing JSON string - %s", err)
...
func TestGetVulnDefinitionsInfo(t *testing.T) {
	...
	tableFile := "../../test_tables/integrationhealth/getvulndefinitionsinfo.json"
	State, err := ioutil.ReadFile(tableFile)
	if err != nil {
		t.Errorf("could not read test table file: %d", err)
	}
	...
	for _, tt := range getTests {
		t.Run(tt.Name, func(t *testing.T) {
			...
			msi, err := acs.IntegrationHealth.GetVulnDefinitionsInfo(testParams.args)
        			if msi != nil {
				jsonbyte, err := json.Marshal(msi)
				if err != nil {
					t.Errorf("error parsing JSON string - %s", err)
