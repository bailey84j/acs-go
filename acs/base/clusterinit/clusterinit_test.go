...
func TestGetCAConfig(t *testing.T) {
	...
	for _, tt := range getTests {
		t.Run(tt.Name, func(t *testing.T) {
			...
			msi, err := acs.ClusterInit.GetCAConfig(testParams.args)
        			if msi != nil {
...
func TestGetInitBundles(t *testing.T) {
	// variables declaration
	...
	tableFile := "../../test_tables/clusterinit/getinitbundles.json"
	State, err := ioutil.ReadFile(tableFile)
	if err != nil {
		t.Errorf("could not read test table file: %d", err)
	}
	...
	for _, tt := range getTests {
		t.Run(tt.Name, func(t *testing.T) {
			...
			msi, err := acs.ClusterInit.GetInitBundles(testParams.args)
        			if msi != nil {
				jsonbyte, err := json.Marshal(msi)
				if err != nil {
					t.Errorf("error parsing JSON string - %s", err)
...
func TestRevokeInitBundle(t *testing.T) {
	// variables declaration
	...
	tableFile := "../../test_tables/clusterinit/revokeinitbundle.json"
	State, err := ioutil.ReadFile(tableFile)
	if err != nil {
		t.Errorf("could not read test table file: %d", err)
	}
	...
	for _, tt := range getTests {
		t.Run(tt.Name, func(t *testing.T) {
			...
			msi, err := acs.ClusterInit.RevokeInitBundle(testParams.args)
        			if msi != nil {
				jsonbyte, err := json.Marshal(msi)
				if err != nil {
					t.Errorf("error parsing JSON string - %s", err)
...
func TestGenerateInitBundle(t *testing.T) {
	// variables declaration
	...
	tableFile := "../../test_tables/clusterinit/generateinitbundle.json"
	State, err := ioutil.ReadFile(tableFile)
	if err != nil {
		t.Errorf("could not read test table file: %d", err)
	}
	...
	for _, tt := range getTests {
		t.Run(tt.Name, func(t *testing.T) {
			...
			msi, err := acs.ClusterInit.GenerateInitBundle(testParams.args)
        			if msi != nil {
				jsonbyte, err := json.Marshal(msi)
				if err != nil {
					t.Errorf("error parsing JSON string - %s", err)
