package compliancemanagement_test
...
type compliancemanagementTests struct {
	Name   string
...
func TestGetRecentRuns(t *testing.T) {
	...
	tableFile := "../../test_tables/compliancemanagement/getrecentruns.json"
	State, err := ioutil.ReadFile(tableFile)
	if err != nil {
		t.Errorf("could not read test table file: %d", err)
	}

	var getTests []compliancemanagementTests
	...
	for _, tt := range getTests {
		t.Run(tt.Name, func(t *testing.T) {
			...
			msi, err := acs.ComplianceManagement.GetRecentRuns(testParams.args)
        			if msi != nil {
...
func TestGetRunStatuses(t *testing.T) {
	...
	tableFile := "../../test_tables/compliancemanagement/getrunstatuses.json"
	State, err := ioutil.ReadFile(tableFile)
	if err != nil {
		t.Errorf("could not read test table file: %d", err)
	}
	...
	for _, tt := range getTests {
		t.Run(tt.Name, func(t *testing.T) {
			...
			msi, err := acs.ComplianceManagement.GetRunStatuses(testParams.args)
        			if msi != nil {
				jsonbyte, err := json.Marshal(msi)
				if err != nil {
					t.Errorf("error parsing JSON string - %s", err)
...
func TestTriggerRuns(t *testing.T) {
	...
	tableFile := "../../test_tables/compliancemanagement/triggerruns.json"
	State, err := ioutil.ReadFile(tableFile)
	if err != nil {
		t.Errorf("could not read test table file: %d", err)
	}
	...
	for _, tt := range getTests {
		t.Run(tt.Name, func(t *testing.T) {
			...
			msi, err := acs.ComplianceManagement.TriggerRuns(testParams.args)
        			if msi != nil {
				jsonbyte, err := json.Marshal(msi)
				if err != nil {
					t.Errorf("error parsing JSON string - %s", err)
