...
func (a Role) PostPermissionSet(args map[string]interface{}) {
...
func (a Role) CreateRole(name string,args map[string]interface{}) {
...
func (a Role) PostSimpleAccessScope(args map[string]interface{}) {
...
func (a Role) PutPermissionSet(id string,args map[string]interface{}) {
...
func (a Role) UpdateRole(name string,args map[string]interface{}) {
...
func (a Role) PutSimpleAccessScope(id string,args map[string]interface{}) {
